...
# Warm Up 3
# Write a Python Function that add two integral numbers in string form and then print out the result.
...
# print out a message to show if the number is too low, too high, or correct number. Show a message if the user wants to
# exit from the game.
# Hint: import random
'''import random
...
# Ex 7 Write a python program using Module Method to create a simple calculator program. (add, subtract, Multiply, divide, power).
...
# Ex 7 Write a python program using Module Method to create a simple calculator program. (add, subtract, Multiply, divide, power).
# Remember to create two files: 1. contain the all methods. 2. contain the main program + from ....import statement.
'''
from calc import addition, subtraction, division, multiplication, power
